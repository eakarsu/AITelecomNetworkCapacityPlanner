...
export default function CfDynamicSpectrumSharingOptimizationAcross4g5g() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-dynamic-spectrum-sharing-optimization-across-4g-5g/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-dynamic-spectrum-sharing-optimization-across-4g-5g', project: 'AITelecomNetworkCapacityPlanner' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-dynamic-spectrum-sharing-optimization-across-4g-5g/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Dynamic spectrum sharing optimization across 4G/5G</h1>
